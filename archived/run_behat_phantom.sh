...
if [ -z "${BehatProfileToUseOnDay}" ]; then
    BehatProfileToUseOnDay="phantomjs-selenium-linux phantomjs-selenium-linux phantomjs-selenium-linux phantomjs-selenium-linux phantomjs-selenium-linux phantomjs-selenium-linux phantomjs-selenium-linux"
fi
